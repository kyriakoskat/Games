...
while True:  
    ...
    if (hit_ball.xcor() > 360 and  
                        hit_ball.xcor() < 370) and (hit_ball.ycor() < right_paddle.ycor() + 80 and  
                        hit_ball.ycor() > right_paddle.ycor() - 80):  
                        hit_ball.setx(360)  
                        hit_ball.dx *= -1  
          
    if (hit_ball.xcor() < -360 and  
                       hit_ball.xcor() > -370) and (hit_ball.ycor() < left_paddle.ycor() + 80 and  
                       hit_ball.ycor() > left_paddle.ycor() - 80):  
                       hit_ball.setx(-360)  
                       hit_ball.dx *= -1  